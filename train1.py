...
data_files = ['./data/activityrecognition.pkl','./data/testactivity.pkl']
class_names = ['communication','playing']
...
def load_dataset(data_files, batch_size, split_size=0):
    ...
    """
    features, labels = [], []
    with open('./data/activityrecognition.pkl', 'rb') as f:
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(os.path.join(save_folder, 'tsstg-model10.pth')))
